...
def create_data_lists(voc07_path,voc12_path,voc07test_path,output_folder):
    """
    ...
    voc07_path=os.path.abspath(voc07_path) #voc07的绝对路径
    ...
    for path in [voc07_path,voc12_path]: #_path应该是文件夹的名称，len[voc07_path,voc12_path]=2
        ...
        with open(os.path.join(path,'ImageSets/Main/trainval.txt')) as f:
            ...
            ids=f.read().splitlines() #这是一个list 值得注意的是,该文件夹下有一个trainval.txt的文件，只存有id号
...
if __name__=='__main__':
    create_data_lists(voc07_path='./VOC2007_trainval',voc12_path='./VOC2012_trainval',voc07test_path='./VOC2007_test',output_folder='./')
